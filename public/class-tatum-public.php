...
class Tatum_Public
{
    ...
    public function woocommerce_validate_address_checkout()
    {
        ...
        foreach (array('ETH', 'CELO', 'BSC') as $chain) {
            ...
            if ($mint_hash && $api_key) {
                foreach (array('ETH', 'CELO', 'BSC') as $chain) {
                    ...
                    if ($recipient_address) {
                        $transfer_body = array('to' => $recipient_address, 'chain' => $chain, 'tokenId' => get_post_meta($product_id, 'tatum_token_id', true), 'contractAddress' => $contract_address, 'fromPrivateKey' => $private_key);
                        if ($chain === 'CELO') {
